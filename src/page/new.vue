<template>
    <div class="set">
        ...
        <div class="menu">
            <el-row>
                <el-col :span="12">
                  <el-form  :model="dataList" :rules="rules"   label-width="100px" class="demo-ruleForm login-container" id="register">
                    ...
                    <el-form-item label="文章类型" prop="type" >
                     ...
                     <el-form-item label="内容" prop="content" >
                      <el-input v-model="dataList.content" type="textarea"></el-input>
                  </el-form-item>
                    ...
                    <el-form-item>
                    <el-button type="primary" @click="addNewFrame" >添加</el-button>
